	...
	final class OceanWP_Post_Metabox {
		...
		public function register( $butterbean, $post_type ) {
			...
			$butterbean->register_manager(
		        'oceanwp_mb_settings',
		        array(
		            'label'     => esc_html__( 'OceanWP Settings', 'ocean-extra' ),
			...
			$manager->register_control(
		        ...
		        array(
		            ...
		            'description'   => esc_html__( 'Choose which menu displays on this page.', 'ocean-extra' ),
			...
			$manager->register_control(
		        ...
		        array(
		            ...
		            'type'    		=> 'buttonset',
		            'label'   		=> esc_html__( 'Display Title', 'ocean-extra' ),
		            'description'   => esc_html__( 'Enable or disable the page title.', 'ocean-extra' ),
					'choices' 		=> array(
						'default' 	=> esc_html__( 'Default', 'ocean-extra' ),
						'' 			=> esc_html__( 'Enable', 'ocean-extra' ),
						'on' 		=> esc_html__( 'Disable', 'ocean-extra' ),
					),
		        )
		    );
			...
			$manager->register_control(
		        ...
		        array(
		            ...
		            'description'   => esc_html__( 'Select a color. Hex code or rgba value, ex: #fff', 'ocean-extra' ),
		        )
		    );
			...
			$manager->register_control(
		        ...
		        array(
		            ...
		            'description'   => esc_html__( 'Select a color. Hex code or rgba value, ex: #ddd', 'ocean-extra' ),
		        )
		    );
