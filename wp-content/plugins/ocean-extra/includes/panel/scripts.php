...
class Ocean_Extra_Scripts_Panel {
	...
	private static function get_scripts() {
		...
		$scripts = array(
			...
			'oe_hamburgers_button_style' => array(
				'label' => esc_html__( 'Hamburgers Button', 'ocean-extra' ),
				'desc' 	=> esc_html__( 'This style is all the css for the hamburgers button used for the mobile menu and in some extensions.', 'ocean-extra' ),
				'type' 	=> 'css',
			),
	...
	public static function generate_css() {
		...
		$hamburgers 			= self::get_setting( 'oe_hamburgers_button_style' );
		...
		if ( ! $customSelect
			...
			// Load hamburgers
			if ( $hamburgers ) {
				$aFiles[] = $tDir .'plugins/hamburgers/_base.scss';
				$aFiles[] = $tDir .'plugins/hamburgers/types/_3dx.scss';
				$aFiles[] = $tDir .'plugins/hamburgers/types/_3dx-r.scss';
				$aFiles[] = $tDir .'plugins/hamburgers/types/_3dy.scss';
				$aFiles[] = $tDir .'plugins/hamburgers/types/_3dy-r.scss';
				$aFiles[] = $tDir .'plugins/hamburgers/types/_3dxy.scss';
				$aFiles[] = $tDir .'plugins/hamburgers/types/_3dxy-r.scss';
				$aFiles[] = $tDir .'plugins/hamburgers/types/_arrow.scss';
				$aFiles[] = $tDir .'plugins/hamburgers/types/_arrow-r.scss';
				$aFiles[] = $tDir .'plugins/hamburgers/types/_arrowalt.scss';
				$aFiles[] = $tDir .'plugins/hamburgers/types/_arrowalt-r.scss';
				$aFiles[] = $tDir .'plugins/hamburgers/types/_arrowturn.scss';
				$aFiles[] = $tDir .'plugins/hamburgers/types/_arrowturn-r.scss';
				$aFiles[] = $tDir .'plugins/hamburgers/types/_boring.scss';
				$aFiles[] = $tDir .'plugins/hamburgers/types/_collapse.scss';
				$aFiles[] = $tDir .'plugins/hamburgers/types/_collapse-r.scss';
				$aFiles[] = $tDir .'plugins/hamburgers/types/_elastic.scss';
				$aFiles[] = $tDir .'plugins/hamburgers/types/_elastic-r.scss';
				$aFiles[] = $tDir .'plugins/hamburgers/types/_minus.scss';
				$aFiles[] = $tDir .'plugins/hamburgers/types/_slider.scss';
				$aFiles[] = $tDir .'plugins/hamburgers/types/_slider-r.scss';
				$aFiles[] = $tDir .'plugins/hamburgers/types/_spin.scss';
				$aFiles[] = $tDir .'plugins/hamburgers/types/_spin-r.scss';
				$aFiles[] = $tDir .'plugins/hamburgers/types/_spring.scss';
				$aFiles[] = $tDir .'plugins/hamburgers/types/_spring-r.scss';
				$aFiles[] = $tDir .'plugins/hamburgers/types/_stand.scss';
				$aFiles[] = $tDir .'plugins/hamburgers/types/_stand-r.scss';
				$aFiles[] = $tDir .'plugins/hamburgers/types/_squeeze.scss';
				$aFiles[] = $tDir .'plugins/hamburgers/types/_vortex.scss';
				$aFiles[] = $tDir .'plugins/hamburgers/types/_vortex-r.scss';
			}
